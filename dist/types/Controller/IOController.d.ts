...
declare class IOController {
    ...
    isPaused(): boolean;
    get status(): number;
    get extraData(): number | null;
    set extraData(data: number | null);
    get onDataArrival(): Function | null;
    set onDataArrival(callback: Function | null);
    get onSeeked(): Function | null;
    set onSeeked(callback: Function | null);
    ...
    get onRedirect(): Function | null;
    set onRedirect(callback: Function | null);
    get onRecoveredEarlyEof(): Function | null;
    set onRecoveredEarlyEof(callback: Function | null);
    get onManifestParsed(): Function | null;
    set onManifestParsed(callback: Function | null);
